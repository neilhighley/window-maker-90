...
```
pip install opencv-python natsort argparse
```

## Populate the images folder, and videos folder and create an output folder then run the script

```
mkdir images, videos, output
```
